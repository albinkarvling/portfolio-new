import {AlternateEmail, GitHub, LinkedIn, OpenInNew} from "@mui/icons-material";
import {SvgIconOwnProps} from "@mui/material";

export function renderIcon(
    iconTitle: string,
    size: SvgIconOwnProps["fontSize"] = "inherit",
) {
    switch (iconTitle) {
        case "GitHub":
            return <GitHub fontSize={size} />;
        case "LinkedIn":
            return <LinkedIn fontSize={size} />;
        case "Email":
            return <AlternateEmail fontSize={size} />;
        case "Website":
